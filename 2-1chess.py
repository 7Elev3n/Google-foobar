'''
Given the chessboard below, a starting and ending position (e.g. 0, 10), find the smallest number of moves a Knight would have to make to get from the start to the end position. 
